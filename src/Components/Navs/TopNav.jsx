...
const hideCollapse=()=> {
    ...
    return ( 
        <div>
            ...
            <div className="navbar-main nav pt-3 pb-1 mb-5" style={showMenu ? {backgroundColor:"white"} : {}}>
                ...
                <div className="col-6 text-end link-nav ul-nav-left">
                        ...
                        <div className="box-login">
                            <NavLink to="/shoppingcart" className="link ml-4"><img src="icon/shoppingcart.png" alt="سبد خرید"/><span id="total-cart" className="badge">{context.persons.length}</span></NavLink>
                            <NavLink to="/login"><img src="icon/login.png" alt="ورود به سایت"/></NavLink>
                            {" "}
                        </div>
                </div>
           </div>
